...
class DynamicPillarVFE(VFETemplate):
    ...
    def forward(self, batch_dict, **kwargs):
        ...
        search_points = batch_dict['search_points']
        template_points = batch_dict['template_points']
        batch_dict['template_pillar_features'] ,batch_dict['template_voxel_coords']= self.forward_feature(template_points)
        batch_dict['search_pillar_features'] ,batch_dict['search_voxel_coords']= self.forward_feature(search_points)
        return batch_dict

    def forward_feature(self, points, **kwargs):
