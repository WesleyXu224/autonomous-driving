...
class PillarRes18BackBone8x(nn.Module):
    def __init__(self, model_cfg, input_channels, grid_size, **kwargs):
        ...
        self.conv3 = spconv.SparseSequential(
            ...
            SparseBasicBlock(32, 32, norm_fn=norm_fn, indice_key='res3'),
            SparseBasicBlock(32, 32, norm_fn=norm_fn, indice_key='res3'),
        )

        self.conv4 = spconv.SparseSequential(
            # [400, 352] <- [200, 176]
            block(32, 32, 3, norm_fn=norm_fn, stride=1, padding=1, indice_key='spconv4', conv_type='spconv'),
            SparseBasicBlock(32, 32, norm_fn=norm_fn, indice_key='res4'),
            SparseBasicBlock(32, 32, norm_fn=norm_fn, indice_key='res4'),
        )
        ...
        self.conv5 = nn.Sequential(
            # [200, 176] <- [100, 88]
            dense_block(32, 32, 3, norm_fn=norm_fn, stride=1, padding=1),
            BasicBlock(32, 32, norm_fn=norm_fn),
            BasicBlock(32, 32, norm_fn=norm_fn),
        )
