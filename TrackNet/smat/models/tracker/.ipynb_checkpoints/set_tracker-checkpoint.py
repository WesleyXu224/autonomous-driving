...
class SetTracker(nn.Module):
    def __init__(self, model_cfg, num_class, dataset):
        ...
        self.module_topology = [
            ...
            'backbone_2d', 'transformer_backbone', 'neck', 'decoder_head'#修改为backbone_3d
        ]
    ...
    def build_vfe(self, model_info_dict):
        ...
        vfe_module = vfe.__all__[self.model_cfg.VFE.NAME](
            ...
            grid_size=model_info_dict['grid_size'],#dynpillarvfe
...
#     def build_resnet_backbone_3d(self, model_info_dict):
#         if self.model_cfg.get('RESNET_BACKBONE_3D', None) is None:
#             return None, model_info_dict
        
#         resnet_backbone_3d_module = resnet_backbone_3d.
